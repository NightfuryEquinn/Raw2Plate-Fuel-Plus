...
export default function AddRecipeToTrackerModal( { comment = "", setComment = null, modal, showModal, modalDate, setModalDate, openDrop, dropValue, dropItems, setOpenDrop, setDropValue, save }: any ) {
